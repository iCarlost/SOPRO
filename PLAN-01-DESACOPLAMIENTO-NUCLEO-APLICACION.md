...
**Estado:** N0 cerrado (PR #2, `508188a`); N1 cerrado (PR #3, `b9a4576`+`eaa2f67`); N2 cerrado; N3 (slice inicial de Application) cerrado; N4 cerrado (PRs N4-1..N4-5 integrados, Gate N4 operativo cerrado); N5 cerrado (PRs N5-20..N5-25 integrados, Gate N5 cerrado); N6 cerrado (PRs N6-1..N6-5 integrados, Gate N6 operativo cerrado); N7 en curso (N7-1a..N7-1e integrados con evaluador puro de grafos, adaptador de snapshot y orden topológico canónico compartido por importación/propagación/recálculo global, más verificación de aciclicidad del grafo externo); N7-2 iniciado (corrección contable de signos en Explosión/Programación, fila 21 de N0-TABLA).
