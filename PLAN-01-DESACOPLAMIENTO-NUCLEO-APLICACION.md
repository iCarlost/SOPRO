...
**N7-17a (en curso):** caracterización del flujo legacy de financiamiento (`FinanciamientoCalculationService`) mediante goldens calculados a mano — anticipo y amortización con caps, desfase de cobro, base "SobreCD" vs "Acumulable", modelo dual con saldos mixtos, residuo de distribución, y guards (sin programa/periodos/base 0) — sin migrar código; servirá de oráculo para la centralización en Sopro.Calculation.  
