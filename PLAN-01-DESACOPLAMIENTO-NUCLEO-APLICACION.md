...
**Estado:** N0 cerrado (PR #2, merge `508188a`); N1 implementado — `SOPRO.Calculation` creado con Gate N1 verificado (suite 178/178, cobertura del núcleo 100% líneas / 100% ramas, consumidor externo desde feed local); pendiente integración del PR N1  
