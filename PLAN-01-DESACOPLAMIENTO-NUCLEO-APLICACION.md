...
**N7-17b en curso (rama `feat/n7-17b-financing-calculator`, sin integrar):** calculador puro `FinancingCalculator` en Sopro.Calculation con entrada/resultado inmutables, base de acumulación como enum (`FinancingBaseCalculationMode`), política de precisión explícita (`FinancingPrecision`; legado 8/6/4/5) y tests puros contra los 8 goldens de N7-17a; aún no se delega producción (adaptador EF→escalares en Sopro.Application reservado para N7-17c).
