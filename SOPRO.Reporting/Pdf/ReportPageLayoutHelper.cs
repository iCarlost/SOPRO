...
/// <summary>
/// Cálculos de formato de página (misma política que ReportPageLayoutHelper
/// de SOPRO.WinForms.Services). Port necesario para reproducir el layout legacy.
/// </summary>
internal static class ReportPageLayoutHelper
{
    ...
    public static MOrientation DetermineAutoOrientation(
        IEnumerable<(string key, int widthPx)> columns, double leftMarginCm = 1.0, double rightMarginCm = 1.0)
    {
