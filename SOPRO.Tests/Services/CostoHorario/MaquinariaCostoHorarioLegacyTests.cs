...
/// La fórmula canónica vive en <see cref="HourlyCostCalculator"/> (SOPRO.Calculation);
/// Maquinaria y WinForms delegan en ella a través de <see cref="MaquinariaHourlyCostAdapter"/>.
