...
/// <summary>
/// ORÁCULO LITERAL (N7-1b): copia exacta de MatrixComponentCalculationService.Recalculate
/// tomada de main (ebf68ae, post-N6-5) en el momento de delegar el servicio al evaluador
/// puro del grafo. Sirve como diferencial real servicio-vs-legacy; no usar en producción.
/// </summary>
internal static class MatrixComponentCalculationLegacyOracle
{
