...
namespace SOPRO.WinForms.Services
{
    public sealed class GeneradorExcelProgramaObra : GeneradorExcelProgramaBase
    {
            ...
            ConfiguracionTituloReporte? tituloCfg = null)
        {
            ...
            return GenerarCore(proyecto, plantilla, columnas, filas, ganttModel, ganttVisualSettings, footerMode, timelineCellWidth, tituloReporte, "ProgramaObra", rutaDestino, tituloCfg);
        }
